...
public class Authenticate {
	...
	public static String authenticate (String uname , String pwd) throws InterruptedException{
		 ...
		 System.out.println("***********Authenticate Called********** Uname "+uname+" pwd "+pwd);
		 ...
		 if (uname.equals("") || pwd.equals("") ){
			return  Myconstants.fieldscantbenull;
				...
				List<User> ulist =GenricDao.getListbyUsername(User.class, uname); //getting list of users with passed ussername
